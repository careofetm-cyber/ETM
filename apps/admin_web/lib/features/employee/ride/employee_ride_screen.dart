...
class EmployeeRideScreen extends ConsumerStatefulWidget {
  const EmployeeRideScreen({super.key});
  @override
  ConsumerState<EmployeeRideScreen> createState() => _EmployeeRideScreenState();
}

class _EmployeeRideScreenState extends ConsumerState<EmployeeRideScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_otpData == null || _trip == null) return _buildNoTrip();
    if (_otpData!['verified'] == true) return _buildVerified();
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              onPressed: () => context.push('/employee/tracking'),
