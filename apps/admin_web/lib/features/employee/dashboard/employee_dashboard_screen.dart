...
class _EmployeeDashboardScreenState extends ConsumerState<EmployeeDashboardScreen> {
                ...
                if (_dashboard != null) ...[
                  if (isWide)
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(flex: 3, child: _buildStatSection()),
  ...
  Widget _buildQuickActionsCard() {
    final actions = [
      _QuickAction(Icons.route, 'My Trips', () => context.go('/employee/trips'), const Color(0xFF2563EB)),
      _QuickAction(Icons.calendar_month, 'Roster', () => context.go('/employee/roster'), const Color(0xFF7C3AED)),
      _QuickAction(Icons.swap_horiz, 'Requests', () => context.push('/employee/request-adjustment'), const Color(0xFFD97706)),
      _QuickAction(Icons.location_on, 'Tracking', () => context.push('/employee/tracking'), const Color(0xFF059669)),
      _QuickAction(Icons.notifications, 'Alerts', () => context.go('/notifications'), const Color(0xFF6366F1)),
      _QuickAction(Icons.warning_amber, 'SOS', () => context.push('/employee/sos'), const Color(0xFFDC2626)),
    ];
