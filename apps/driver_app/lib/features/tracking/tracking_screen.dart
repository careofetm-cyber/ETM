                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      driverLat != null ? '${double.tryParse(driverLat.toString())?.toStringAsFixed(4)}, ${double.tryParse(driverLng.toString())?.toStringAsFixed(4)}' : 'Location pending',
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: _passengers.isEmpty
                                          ? Center(
                                              child: Text('No passengers', style: TextStyle(color: cs.onSurfaceVariant)),
                                            )
                                          : ListView.separated(
